...
const advancedTestData = [
  {
    question:
      'Оберіть найбільш підходящий варіант для завершення речення: "Had I known about the traffic jam, I ____ a different route."',
  ...
  {
    question:
      'Оберіть правильний варіант, що демонструє інверсію: "____ did he realize the gravity of the situation."',
    options: ["Only then", "Then only", "He only then", "Only then he"],
    correctAnswerIndex: 0,
  },
  {
    question:
      'Оберіть речення, яке найкраще передає значення: "He has a bone to pick with you."',
    options: [
      "He wants to share a meal with you.",
      "He needs your help with a problem.",
      "He has a grievance to discuss with you.",
      "He is fond of you.",
    ],
  ...
  {
    question:
      'Оберіть правильний варіант: "Despite ____ hard, he failed the exam."',
    options: ["he studied", "of studying", "having studied", "to study"],
    correctAnswerIndex: 3,
  },
  {
    question:
      'Оберіть слово, яке найкраще замінить виділене: "The **insidious** nature of the disease made it difficult to detect early."',
    options: ["harmless", "beneficial", "treacherous", "obvious"],
    correctAnswerIndex: 3,
  },
  {
    question:
      'Оберіть правильний варіант: "Scarcely ____ the door when the phone rang."',
  ...
  {
    question:
      "Оберіть речення, яке містить помилку в уживанні умовного способу:",
    options: [
      "If I were a bird, I would fly.",
      "If he had come, we would have gone.",
      "If she would have known, she would tell us.",
...
const AdvancedTest = () => {
  ...
  const handleAnswer = (selectedIndex) => {
    if (
      selectedIndex === advancedTestData[currentQuestion].correctAnswerIndex
    ) {
      setScore(score + 1);
    }
        ...
        <>
          <h2>
            ...
            <p className="easy-test-question">
              {" "}
              Питання {currentQuestion + 1} з {advancedTestData.length}
            </p>
          </h2>
          <p className="question-text">
            {advancedTestData[currentQuestion].question}
          </p>
