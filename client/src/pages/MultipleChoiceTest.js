...
const MultipleChoiceTest = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            ...
            try {
                const response = await fetch('http://localhost:3001/api/exercises/multiple-choice', {
    headers: {
                ...
                {selectedAnswer && (
                    <div className="add-to-dictionary-container">
                        <button 
                            ...
                            onClick={() => handleAddToDictionary(currentQuestion.word_to_learn)}
                        >
                    ...
                    {currentQuestion.options.map((option, index) => (
                        <button 
                            ...
                            className={`answer-btn 
                                ${selectedAnswer && option === currentQuestion.correct_answer ? 'correct' : ''}
